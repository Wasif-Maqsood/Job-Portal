    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jobType', models.CharField(choices=[('Parmanent', 'Permanent'), ('Temporary', 'Temporary'), ('Intership', 'Intership')], default='Parmanent', max_length=10)),
                ...
                ('Experience', models.CharField(choices=[('NO EXPERIENCE', 'No Experience'), ('1 YEAR', 'One Year'), ('2 YEARS', 'Two Year'), ('3 YREAS ABOVE', 'Three Year Plus')], default='NO EXPERIENCE', max_length=20)),
